    ...
    refetch()
      .then((response) => {
        if (response.data?.resumen) {
          addToast({
            title: "Éxito",
            description: `Datos actualizados (${(response.data.resumen.total_transacciones_ingresos + response.data.resumen.total_transacciones_egresos) || 0} transacciones encontradas)`,
            timeout: 3000,
          });
        } else {
          addToast({
  ...
  return (
    <DefaultLayout>
      <div className="container mx-auto px-4 py-8">
        ...
        {isError && (
          <div className="bg-red-50 border border-red-200 text-red-400 px-6 py-3 rounded mb-6">
        ...
        {!isLoading && !isError && data?.resumen && data?.por_mes && (
          <>
