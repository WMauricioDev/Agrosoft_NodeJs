...
export const postTipo_especie = async (req, res) => {
    try {
        ...
        const sql = `
            INSERT INTO tipo_especies_tipoespecie (nombre, descripcion, img) 
            VALUES ($1, $2, $3) 
            RETURNING id
        `;
...
export const getTipo_especie = async (req, res) => {
    try {
        const sql = `
            ...
            FROM tipo_especies_tipoespecie 
            ORDER BY nombre
        `;
...
export const updateTipo_especie = async (req, res) => {
    try {
        ...
        const sql = `
            UPDATE tipo_especies_tipoespecie 
            SET nombre = $1, descripcion = $2, img = $3 
            WHERE id = $4
        `;
